...
<body>
  ...
  <header>
    <nav class="container">
      <a href="#" class="logo">
        <img class="logo_l show" src="assets/iso_b.svg" alt="">
        <img class="logo_d hidden" src="assets/iso_w.svg" alt="">
      </a>
      <div class="links">
        <ul class="walsheimBold">
          <li>
            <a href="#home" class="nav-link">Inicio</a>
          </li>
          <li>
            <a href="#about" class="nav-link">Quién</a>
          </li>
          <li>
            <a href="#services" class="nav-link">Qué</a>
          </li>
          <li>
    ...
    <section class="showcase-area" id="home">
      ...
      <div class="container">
        <div class="showcase-info">
          ...
          <div class="cta">
            <a href="mailto:markusraik@mail.com" class="btn">Contactanos</a>
            <a href="#portfolio" class="btn secondary-btn">Proyectos</a>
          </div>
        </div>
        <div class="showcase-image">
          <img src="./assets/person1.png" class="person" alt="Team">
    ...
    <section class="about section" id="about">
      ...
      <div class="container">
        <div class="about-grid">
          <div class="about-card">
            <svg class="icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              ...
              <g>
                <path class="st1"
                  d="M148.79,406.67v-75.44c0-5.57-3.15-10.66-8.13-13.14l-13.14-6.57c-4.98-2.5-8.13-7.58-8.13-13.16v-60.74   c0-24.36,19.74-44.1,44.1-44.1h-33.07c-24.36,0-44.1,19.74-44.1,44.1v60.74c0,5.57,3.15,10.66,8.13,13.14l13.14,6.57   c4.98,2.48,8.13,7.58,8.13,13.14v75.44c0,8.11,6.59,14.7,14.7,14.7h33.07C155.37,421.37,148.79,414.78,148.79,406.67L148.79,406.67z">
                </path>
              </g>
              <g>
                <path class="st1"
            ...
            <h3 class="head-icon">UX<br>
            <span class="foot-line">Experiencia de usuario</span></h3>
          </div>
          <div class="about-card">
            <svg class="icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              id="_x31__x2C_5" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;"
            ...
            <h3 class="head-icon">UI<br>
              <span class="foot-line">Interfaz de Usuario</span></h3>
          </div>
          <div class="about-card">
            <svg class="icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              id="_x31__x2C_5" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;"
        ...
        <div class="about-info">
          <h3 class="sub-heading avenirBold">Quién</h3>
          <h1 class="heading walsheimBold">Somos diseñadores, directores
            y estrategas 100% mexicanos.</h1>
          <p class="text">
    ...
    <section class="services section" id="services">
      ...
      <div class="container">
        <div class="services-info">
          <h3 class="sub-heading avenirBold">Servicios</h3>
          <h1 class="heading walsheimBold">¿Qué es lo qué hacemos?</h1>
          <p class="text">
            <span class="avenirBold">Hemos colaborado con marcas y agencias para crear experiencias inolvidables.</span>
            <br>
            Queremos que nos veas como un compañero, más que un recurso creativo,
            para así compartir la visión y perspectiva de trabajar juntos, logrando tus objetivos y metas.
            <br>
            Básicamente seremos tu nuevo mejor amigo.
          </p>
      ...
      <div class="container">
        <div class="portfolio-header">
          ...
          <div class="filter-btns">
            ...
            <button class="filter-btn" data-filter=".development">Desarrollo Web</button>
          ...
          <div class="mix prt-card branding development">
            <div class="prt-image">
              ...
              <div class="prt-overlay">
                ...
                <a target="_blank" href="https://www.behance.net/gallery/141700273/TRADEO-Logistics" class="prt-icon" style="--i: .15s">
                  <i class="uil uil-link-h"></i>
                </a>
              </div>
            </div>
            <div class="prt-desc">
              <h3>TRADEO Logistics</h3>
    ...
    <section class="testimonials section">
      <div class="container">
        <div class="section-background">
          <img src="./assets/person2.png" class="person" alt="">
          <img src="./assets/circle2.png" alt="" class="circle">
          <img src="./assets/square1.png" alt="" class="square">
        </div>
        <div class="swiper">
        ...
        <div class="testimonials-title">
          ...
          <h1 class="heading walsheimBold">Últimas <br>reseñas</h1>
        </div>
      </div>
    </section>
  ...
  <footer>
    <div class="container">
      ...
      <p class="text">&copy; Todos los derechos reservados <?php echo date('Y') ?> | Houdle&reg;</p>
