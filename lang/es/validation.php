...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'state_id' => [
            'required' => 'Debes elegir un Estado.'
        ],
        'city_id' => [
            'required' => 'Debes elegir una Ciudad.'
        ],
        'address' => [
            'required' => 'Debes introducir una dirección.'
        ],
        'cp' => [
            'required' => 'Debes introducir un Código Postal.'
        ],
        'references' => [
            'required' => 'La referencía del lugar es necesaria.'
        ],
        'contact' => [
            'required' => 'El nombre del contacto es necesario.'
        ],
        'phone' => [
            'required' => 'El teléfono de contacto es necesario.'
        ],
        'name' => [
        ...
        'subcategory_id' => [
            'required' => 'Debes elegir una subcategoría.'
        ],
        'slug' => [
            'required' => 'El campo Slug es obligatorio.',
            'unique:products' => 'El campo Slug debe ser único'
        ],
        'description' => [
            'required' => '¡Cuentanos! ¿Qué es lo que buscas?'
        ],
        'brand_id' => [
            'required' => 'Debes elegir una marca.'
        ],
        'price' => [
        ...
        'terms' => [
            'required' => 'El campo términos del servicio es obligatorio.'
        ]
    ],
